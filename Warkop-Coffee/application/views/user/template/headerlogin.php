...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="<?= base_url(); ?>user/index">Warkop<small>Coffee</small></a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <!-- <li class="nav-item"><a href="<?= base_url(); ?>home/katalog" class="nav-link">Menu</a></li> -->
                    <li class="nav-item cart"><a href="<?= base_url(); ?>login" class="nav-link"><span class="icon icon-lock"></span></a></li>
                </ul>
            </div>
        </div>
    </nav>
